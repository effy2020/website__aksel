            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="card-title">Page de Diapositive Accueil</h4>
                        ...
                        <form method="post" action="{{ route('update.slider') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Image de la Diapositive</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($homeslide->home_slide)) ? url($homeslide->home_slide) : url('upload/no_image.jpg') }}" alt="Aperçu de l'image">
                                </div>
                            </div>
                            <!-- fin de la ligne -->

                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Mettre à jour la Diapositive">
                        </form>
