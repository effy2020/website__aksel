                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('category.update') }}" id="myForm" >
                            ...
                            <div class="row mb-3">
                                <label for="example-text-input" class="col-sm-2 col-form-label">Price per km</label>
                                <div class="form-group col-sm-10">
                                    <input name="price_per_km" value="{{ $category->price_per_km }}" class="form-control" type="number">
                                </div>
                            </div>
                            <!-- end row --> 
    ...
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages: {
                ...
                price_per_km: {
                    required : 'Please Enter the Price per km',
