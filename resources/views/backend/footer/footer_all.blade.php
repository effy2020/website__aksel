...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Page de Pied de Page</h4>
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Numéro</label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Droits d'auteur</label>
                <div class="col-sm-10">
            ...
            <input type="submit" class="btn btn-info waves-effect waves-light" value="Mettre à jour la page de pied de page">
            </form>
