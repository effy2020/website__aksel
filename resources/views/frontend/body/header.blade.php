...
@endphp
   ...
   <header>
    ...
    <nav class="menu__nav">
    <div class="logo">
    <a  class="logo__black"><img src="{{ asset('frontend/assets/img/logo/logo_black.png') }}" alt=""></a>
    <a  class="logo__white"><img src="{{ asset('frontend/assets/img/logo/logo_white.png') }}" alt=""></a>
    </div>
...
<!-- Bouton pour les téléphones et les ordinateurs -->
<div class="header__btn d-none d-md-block">
    <a href="tel:+1234567890" class="btn" onclick="handleClick2(event)">Appelez-nous</a>
</div>
